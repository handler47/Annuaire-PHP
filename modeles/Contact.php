...
class Contact extends Element{
	...
	public function displayRow(){
		...
		echo '<td align="center"> <a href="http://localhost/Annuaire-PHP/index.php?details='.$this->getID().'" >details</a> </td>';
		echo '<td align="center"><a href="http://localhost/Annuaire-PHP/index.php?supprimer='.$this->getID().'">supprimer</a>  </td>';
		echo '</tr>';
	}
